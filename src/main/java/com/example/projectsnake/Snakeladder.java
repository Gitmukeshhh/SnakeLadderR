...
public class Snakeladder extends Application {
    ...
    public Pane createContent(){
        ...
        Image img=new Image("C:\\Users\\Dell\\IdeaProjects\\projectSnake\\src\\snakepic2.jpg");
        ImageView boardImage =new ImageView();
        boardImage.setImage(img);
        boardImage.setFitWidth(tileSize*width);
        boardImage.setFitHeight(tileSize*height);
        tileGroup.getChildren().addAll(boardImage,playerOneButton,gameButton,playerTwoButton,playerOne.getGamePiece(),playerTwo.getGamePiece(),randResult);
      ...
      private  void getDiceValue(){
        ...
        randResult.setText(Integer.toHexString(diceValue));
      }
